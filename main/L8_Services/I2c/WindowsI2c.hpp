...
private:
    ...
    bool MasterStop(
        void* cmd) override;
    bool MasterWriteDeviceAddress(
        void* cmd, 
        uint8_t deviceAddress) override;
    bool MasterWriteRegisterAddress(
        void* cmd,
        uint8_t registerAddress) override;
    bool MasterWriteByte(
        void* cmd,
        uint8_t byteToWrite) override;
    bool MasterReadByte(
        void* cmd,
        uint8_t* byteToRead) override;
    bool MasterWrite(
        void* cmd,
        const uint8_t* data,
