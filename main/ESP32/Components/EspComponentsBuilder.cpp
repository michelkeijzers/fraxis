...
#include "Common/Components/Mcp23017/EspMcp23017Driver.hpp"
...
void EspComponentsBuilder::BuildDrivers(Models& models)
{
    ...
    /// TODO  _drivers.mcp23017Driver = new EspMcp23017Driver(*(models.mcp23017Model), static_cast<EspI2c&>(*(_drivers.i2c)));
