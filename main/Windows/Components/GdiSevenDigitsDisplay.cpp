...
GdiSevenDigitsDisplay::GdiSevenDigitsDisplay(GdiScreen& gdiScreen, WindowsTm1637& tm1637, int nrOfDigits, bool hasColon, int x, int y)
...
void GdiSevenDigitsDisplay::Update(HDC* hdc)
{
	...
	RECT rect{ _x, _y, _x + D(LENGTH * (_nrOfDigits + 1) + 5), _y + D(WIDTH) }; // +1 for auxiliary segment
