...
void ApplicationsManager::Initialize()
{
    CreateQueues();
    CreateTasks();
...
void ApplicationsManager::Run(bool keepRunning)
{
    StartTasks();
}

void ApplicationsManager::CreateQueues()
{
...
void ApplicationsManager::CreateTasks()
{
...
void ApplicationsManager::StartTasks()
{
...
void ApplicationsManager::ApplicationsTaskFunction(void* param)
{
    ApplicationsTask* applicationsTask = static_cast<ApplicationsTask*>(param);
    applicationsTask->Run();
}

void ApplicationsManager::LedStripsTaskFunction(void* param)
{
    // LedStripsTask* ledStripTask = static_cast<LedStripsTask*>(param);
    // ledStripTask->Run();
}

void ApplicationsManager::I2cTaskFunction(void* param)
{
